 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ws=()=>Es().__FIREBASE_DEFAULTS__,Is=()=>{if(typeof process>"u"||typeof process.env>"u")return;const t={}.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},bs=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&or(t[1]);return e&&JSON.parse(e)},Ut=()=>{try{return ws()||Is()||bs()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},vs=t=>{var e,n;return(n=(e=Ut())===null||e===void 0?void 0:e.emulatorHosts)===null||n===void 0?void 0:n[t]},ar=()=>{var t;return(t=Ut())===null||t===void 0?void 0:t.config},cr=t=>{var e;return(e=Ut())===null||e===void 0?void 0:e[`_${t}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bo="firebase-heartbeat-database",Ho=1,ye="firebase-heartbeat-store";let ft=null;function pr(){return ft||(ft=to(Bo,Ho,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ye)}catch(n){console.warn(n)}}}}).catch(t=>{throw q.create("idb-open",{originalErrorMessage:t.message})})),ft}async function jo(t){try{const n=(await pr()).transaction(ye),r=await n.objectStore(ye).get(mr(t));return await n.done,r}catch(e){if(e instanceof J)M.warn(e.message);else{const n=q.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});M.warn(n.message)}}}async function hn(t,e){try{const r=(await pr()).transaction(ye,"readwrite");await r.objectStore(ye).put(e,mr(t)),await r.done}catch(n){if(n instanceof J)M.warn(n.message);else{const r=q.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});M.warn(r.message)}}}function mr(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ko(t){_e(new ae("platform-logger",e=>new io(e),"PRIVATE")),_e(new ae("heartbeat",e=>new Wo(e),"PRIVATE")),ne(vt,un,t),ne(vt,un,"esm2017"),ne("fire-js","")}Ko("");function Ft(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n}function gr(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Go=gr,_r=new ve("auth","Firebase",gr());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve=new lr("@firebase/auth");function Jo(t,...e){Ve.logLevel<=E.WARN&&Ve.warn(`Auth (${Se}): ${t}`,...e)}function Ue(t,...e){Ve.logLevel<=E.ERROR&&Ve.error(`Auth (${Se}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S(t,...e){throw Bt(t,...e)}function R(t,...e){return Bt(t,...e)}function yr(t,e,n){const r=Object.assign(Object.assign({},Go()),{[e]:n});return new ve("auth","Firebase",r).create(e,{appName:t.name})}function K(t){return yr(t,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Bt(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return _r.create(t,...e)}function p(t,e,...n){if(!t)throw Bt(e,...n)}function k(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Ue(e),new Error(e)}function U(t,e){t||k(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function da(t,e){const n=await wr(t,{},async()=>{const r=Te({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:s}=t.config,o=Ir(t,i,"/v1/token",`key=${s}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Er.fetch()(o,{method:"POST",headers:a,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function ha(t,e){return X(t,"POST","/v2/accounts:revokeToken",ee(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wn(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Cr(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Sr(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Pr(e))return"Blackberry";if(kr(e))return"Webos";if(Ar(e))return"Safari";if((e.includes("chrome/")||Rr(e))&&!e.includes("edge/"))return"Chrome";if(Or(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Sr(t=I()){return/firefox\//i.test(t)}function Ar(t=I()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Rr(t=I()){return/crios\//i.test(t)}function Cr(t=I()){return/iemobile/i.test(t)}function Or(t=I()){return/android/i.test(t)}function Pr(t=I()){return/blackberry/i.test(t)}function kr(t=I()){return/webos/i.test(t)}function $t(t=I()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function fa(t=I()){var e;return $t(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function pa(){return Os()&&document.documentMode===10}function Nr(t=I()){return $t(t)||Or(t)||kr(t)||Pr(t)||/windows phone/i.test(t)||Cr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dr(t,e=[]){let n;switch(t){case"Browser":n=wn(I());break;case"Worker":n=`${wn(I())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Se}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Re extends Ur{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kr{constructor(e,n,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return lc;case"linkViaPopup":case"linkViaRedirect":return dc;case"reauthViaPopup":case"reauthViaRedirect":return uc;default:S(this.auth,"internal-error")}}resolve(e){U(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){U(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ne(il,sl,"app");const ol="AIzaSyChbHkBFTxl5NfYCKpB62F__LcDd1tlI0w",al="vnhappy7-prod.firebaseapp.com",cl="vnhappy7-prod",ll="vnhappy7-prod.firebasestorage.app",ul="1094102782182",dl="1:1094102782182:web:a9fcc8649f73aacbb9ab27",hl="G-MWX77CKP93",fl={apiKey:ol,authDomain:al,projectId:cl,storageBucket:ll,messagingSenderId:ul,appId:dl,measurementId:hl};function pl(){return fr(fl),{firebaseLogin:async(e,n)=>Va(Mn(),e,n).then(r=>{const i=r.user;return i.getIdToken().then(s=>(console.log("user accessToken: ",s),console.log("firebaseUser: ",i),{firebaseUser:i,accessToken:s}))}),getAuth:Mn,firebaseLogout:qa}}const Ge=Zr(ms.get("token")),{getAuth:ml}=pl(),Jr=ml(),T=fs.create({baseURL:"https://api.vnhappy7.com/ops",timeout:5e3,headers:{"Content-Type":"application/json","authorization-firebase":Ge.value?`${Ge.value}`:""}}),Yr=t=>{Ge.value=t,T.defaults.headers["authorization-firebase"]=`${t}`};var Un;(Un=Jr.currentUser)==null||Un.getIdToken().then(t=>{console.log("idToken",t),Yr(t)});console.log("firebaseAuth",Jr);const gl=()=>{Ge.value=""},_l=async()=>{try{return T.post("/login")}catch(t){throw console.log("Error in login:",t),t}},yl=t=>T.patch("user",t),El=t=>{const{category:e,planId:n,planParams:r}=t;return T.post(`plan/${e}/${n}/order`,r)},wl=t=>{const{category:e,orderId:n,planParams:r}=t;return T.put(`plan/${e}/order/${n}`,r)},Il=t=>{const{orderId:e,paymentParams:n}=t;return T.post(`plan/escort/order/${e}/payment`,n)},bl=t=>T.get("/order/detail",{params:t}),vl=t=>T.get(`/order/detail/${t}`),Tl=(t,e,n)=>T.post(`/plan/escort/${t}/estimateFee`,e,{params:n}),Sl=t=>T.put(`plan/escort/order/${t.orderId}`,t.planParams),Al=t=>T.post(`plan/escort/order/${t.orderId}/assign-guides`,{guides:t.guideIds}),Cl={axiosInstance:T,login:_l,removeAuthToken:gl,setAuthToken:Yr,createOrder:El,updateOrder:wl,updateUser:yl,createPayment:Il,getOrders:bl,getOrderDetail:vl,getEstimateFee:Tl,updateEscortOrder:Sl,assignGuidesToOrder:Al};export{Cl as a,pl as u};
//# sourceMappingURL=api-54dd0635.js.map
